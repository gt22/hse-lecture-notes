...
\section{Введение}
    ...
    \subsection{}
        \begin{theorem}
            ...
            \begin{proof}
                \[x \in A\cap\left( \bigcup\limits_{\alpha \in I}B_{\alpha} \right) \implies \exists{\alpha \in I}\quad x \in A\land x \in B_{\alpha} \implies \exists{\alpha \in I}\quad x \in \left( A\cap B_{\alpha} \right) \implies x \in \bigcup\limits_{\alpha \in I}\left( A\cap B \right) .\]
                \[ A\cap\left( \bigcup\limits_{\alpha \in I}B_{\alpha} \right) \subset \bigcup\limits_{\alpha \in I}\left( A\cap B \right) .\] 
